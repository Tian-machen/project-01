...
(function () {
    ...
    function load() {
        ...
        if (!inArray(includes, 'mapbox-gl-enhance') && !inArray(excludes, 'mapbox-gl')) {
            inputCSS('../../web/libs/mapbox-gl-js/1.13.1/mapbox-gl.css');
            inputScript('../../web/libs/mapbox-gl-js/1.13.1/mapbox-gl.js');
        }
        ...
        if (inArray(includes, 'antd')) {
            ...
            inputScript("../../web/libs/moment/2.29.1/moment.min.js");
